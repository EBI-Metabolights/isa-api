...
class TestJsonToSra(TestCase):
    ...
    def test_sra_dump_experiment_set_xml_biis3(self):
        ...
        with open(os.path.join(self._tmp_dir, "experiment_set.xml"), "rb") as es_fp:
            ...
            self.assertTrue(
                utils.assert_xml_equal(self._expected_experiment_set_xml_biis3, actual_experiment_set_xml_biis3)
            )
    ...
    def test_sra_dump_experiment_set_xml_biis7(self):
        ...
        with open(os.path.join(self._tmp_dir, "experiment_set.xml"), "rb") as es_fp:
            ...
            self.assertTrue(
                utils.assert_xml_equal(self._expected_experiment_set_xml_biis7, actual_experiment_set_xml_biis7)
            )
