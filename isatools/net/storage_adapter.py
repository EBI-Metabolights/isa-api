...
class IsaGitHubStorageAdapter(IsaStorageAdapter):
    ...
    def __init__(self, username=None, password=None, note=None, scopes=("gist", "repo")):
        ...
        if username and password:
            ...
            payload = {"scopes": list(scopes), "note": note or "Authorization to access the ISA data sets"}
    ...
    def retrieve(
        ...
        Parameters
            :param source: str - URLish path to the source (within the
            GitHub repository)
            :param destination str - Local file path. Can be absolute or
            relative to the working directory
            :param owner str - the owner (user or organization) of the
            target GitHub repo. Defaults to 'ISA-tools'
            :param repository str - the name of the target repository.
            Defaults to 'isa-api'
    ...
    def _download_dir(self, directory, destination, dir_items, write_to_directory=None):
        """
